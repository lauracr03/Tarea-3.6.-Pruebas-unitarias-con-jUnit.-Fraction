 ...
 * 
 * <li> Construir un objeto Fracción pasándole al constructor el numerador y el denominador. 
 * <li> La fracción se construye simplificada, no se puede dividir por cero.
 *   
 * <li> Obtener resultado de la fracción (número real).
 * <li> Multiplicar la fracción por un número (el método devuelve otra fracción, simplificada).
 * <li> Multiplicar, dividir, sumar y restar fracciones (los métodos devuelven otra fracción, simplificada).
 * 
